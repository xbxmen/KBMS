...
<html>
	...
	<body>
					...
					<div class="show_content">
						...
						<div>
							<ul class="list">
								...
								<li class="fileshow_li">
									<input name="file" class="checkbox" type="checkbox"/>
									<div class="audio_file dir_small inline_block">	
									</div>
									<div class="filename inline_block">
										<a href="#"  class="file_name" >哈利波特全集</a>
										<div class="operate inline_block ">
			...
			<div id="uploadmain">
			    <div id="body" class="light">
			        <div id="content" class="show">
			            <div class="return_pre"><a href="#show_main">回到AUDI</a></div>
			            <div class="demo">
			                    ...
			                    <div class="upload_box">
			                        <div class="upload_main">
			                            <div class="upload_choose">
			                                ...
			                                <span id="fileDragArea" class="upload_drag_area">或者将音频拖到此处</span>
			                            </div>
			                            <div id="preview" class="upload_preview"></div>
			                        </div>
			                        <div class="upload_submit">
			                            <button type="button" id="fileSubmit" class="upload_submit_btn">确认上传音频</button>
			                        </div>
		...
		<script type="text/javascript">
		 	ZXXFILE = $.extend(ZXXFILE, audioparams);
			ZXXFILE.init();
		</script>
	</body>
</html>
